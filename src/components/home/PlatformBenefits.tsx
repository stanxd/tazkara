...
const PlatformBenefits: React.FC = () => {
  ...
  const features = [
    {
      icon: BarChart3,
      title: "قاعدة بيانات موحدة للفرق والجماهير",
      description: [
    ...
    },
    {
      ...
      description: [
        "تمكين المشجع من بيع او اهداء تذكرته",
        "تمكين النادي من حجز تذاكر معينه مسبقا للاهداء",
        ...
        "في حال لم يحضر المشجع لـ 3 مباريات متتالية بحجوزات مؤكدة يتم تغيير حسابة من مشجع مفضل الى قائمة الانتظار للحجوزات الـ ثلاثة القادمة"
      ]
    },
    {
      icon: Award,
