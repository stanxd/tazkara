        ...
        <div className="space-y-4 py-6 rtl text-center">
          ...
          <div className="bg-purple-900/20 p-4 rounded-md border border-purple-500/30 mt-4">
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm text-purple-300 text-right">سيتم إشعارك عند توفر التذاكر في حسابك</p>
            </div>
          </div>
        </div>
        
        <DialogFooter className="sm:justify-center gap-2 rtl">
          <Button type="button" variant="ghost" className="border border-purple-500/20 text-purple-200" onClick={() => onOpenChange(false)}>
            إلغاء
          </Button>
          <Button type="button" className="bg-gradient-to-r from-pink-500 to-purple-500 hover:opacity-90 border-none" onClick={onJoinWaitlist}>
