  ...
  if (realMatchData && realMatchData.length > 0) {
    ...
    realMatchData.forEach(match => {
      try {
        ...
        // Ensure feature is wrapped in an array to match the expected number[][] type
